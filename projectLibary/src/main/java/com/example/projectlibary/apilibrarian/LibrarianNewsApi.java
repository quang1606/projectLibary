...
public class LibrarianNewsApi {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('LIBRARIAN')")
    public ResponseEntity<ResponseData<NewsDetailResponse>> updatePost(@Valid @RequestBody UpdateNewsRequest updateNewsRequest, @RequestParam long id) {
